/**
 * Home Assistant Assist Pipeline types
 * Based on: https://github.com/home-assistant/frontend/blob/dev/src/data/assist_pipeline.ts
 */
...
/**
 * New event type for streaming LLM responses during intent processing
 */
export interface IntentProgressEvent extends PipelineEventBase {
...
/**
 * All possible pipeline run events
 */
